...
const LeftNavBar = ({come}) => {
  ...
  return (
    <div className="p-2">
      ...
      <button className="btn btn-outline btn-info w-full mb-1">
        {" "}
      ...
      {
          come === "home" && (<img src={bg} className="mt-5 w-full h-1250" alt="" />)
      }
      {/* {
          come === "home" && (<img src={bg} className="mt-5 w-full" alt="" />)
      }
      {
          come === "home" && (<img src={bg} className="mt-5 w-full" alt="" />)
      }
